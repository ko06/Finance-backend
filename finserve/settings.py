"""
Django settings for finserve project.
...
SECRET_KEY = "django-insecure-(!5ngh2ctsx^2$*$7%y4p&5*3e3c%n)@xt%7&6jr%+!53kj0ko"
...
ROOT_URLCONF = "finserve.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, "react-app", "build"), os.path.join(BASE_DIR, "templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "finserve.wsgi.application"
